...
### 주요 기술 포인트
- **데이터 시각화 적용**  
  - React + Recharts 기반으로 플레이 성과를 그래프 형태로 제공  
  - 승률, 평균 점수 등 핵심 지표를 직관적으로 확인 가능  

- **사용자 경험 최적화**  
  - 데이터 페이징 및 Lazy Loading 도입으로 성능 최적화  
  - 과거 기록 조회 시에도 빠른 반응 속도 유지  
...
### 주요 기술 포인트
- **문의하기 기능**  
  - 사용자가 직접 질문/건의 사항을 작성 및 제출 가능  
  - 간단하고 직관적인 입력 UI 제공  

- **문의 내역 관리**  
  - 제출된 문의는 마이페이지에서 확인 가능  
  - 관리자 답변 여부를 한눈에 확인할 수 있는 구조 설계  
  - 사용자-관리자 간 원활한 소통 채널 구축  
